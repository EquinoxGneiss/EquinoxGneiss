    ...
    <div class="bg-white rounded-xl border border-gray-200 p-6 space-y-5">
      ...
      <div>
        <label class="flex items-center gap-2 text-sm font-medium text-gray-700 mb-1.5">
          <span class="w-7 h-7 rounded-full bg-blue-600 flex items-center justify-center">
      ...
      <div>
        <label class="flex items-center gap-2 text-sm font-medium text-gray-700 mb-1.5">
          <span class="w-7 h-7 rounded-full flex items-center justify-center" style="background: linear-gradient(135deg, #833ab4, #fd1d1d, #fcb045)">
            <svg class="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 24 24">
        ...
        <input
          ...
          class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-pink-400 focus:border-transparent"
        />
      </div>
      ...
      <div>
        <label class="flex items-center gap-2 text-sm font-medium text-gray-700 mb-1.5">
          <span class="w-7 h-7 rounded-full bg-blue-700 flex items-center justify-center">
            <svg class="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 24 24">
